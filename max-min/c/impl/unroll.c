    ...
    for (int k = 0; k < N; k++)
    {
        ...
        for (; i < N; i++)
        {
            ...
            for (; j < N - 3; j += 4)
            {
                ...
                // compute 1
                double min0 = MIN(cik, ckj0);
                double min1 = MIN(cik, ckj1);
                double min2 = MIN(cik, ckj2);
                double min3 = MIN(cik, ckj3);

                // compute 2
                double res0 = MAX(cij0, min0);
                double res1 = MAX(cij1, min1);
                double res2 = MAX(cij2, min2);
                double res3 = MAX(cij3, min3);
