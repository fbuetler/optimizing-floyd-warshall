    ...
    for (int k = 0; k < L1; k++)
    {
        ...
        for (; i < L1 - 3; i += 4)
        {
            ...
            for (; j < L1 - 3; j += 4)
            {
                ...
                // op 1
                double sum00 = MIN(a0k, bk0);
                double sum01 = MIN(a0k, bk1);
                double sum02 = MIN(a0k, bk2);
                double sum03 = MIN(a0k, bk3);
                double sum10 = MIN(a1k, bk0);
                double sum11 = MIN(a1k, bk1);
                double sum12 = MIN(a1k, bk2);
                double sum13 = MIN(a1k, bk3);
                double sum20 = MIN(a2k, bk0);
                double sum21 = MIN(a2k, bk1);
                double sum22 = MIN(a2k, bk2);
                double sum23 = MIN(a2k, bk3);
                double sum30 = MIN(a3k, bk0);
                double sum31 = MIN(a3k, bk1);
                double sum32 = MIN(a3k, bk2);
                double sum33 = MIN(a3k, bk3);
