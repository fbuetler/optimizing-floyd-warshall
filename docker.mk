...
fw-boost-g++: shortest-path/boost/*
	cd shortest-path/boost && g++ $(CFLAGS) -o $(BUILD_DIR)/$(BUILD_NAME) main.cpp -static

# fw - boost ref
tc-boost-g++: transitive-closure/boost/*
	cd transitive-closure/boost && g++ $(CFLAGS) -o $(BUILD_DIR)/$(BUILD_NAME) main.cpp -static
